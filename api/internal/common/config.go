...
func DefaultConfig() *GlobalConfig {
	return &GlobalConfig{
		...
		RestServer: RestServer{
			...
			BaseURL:           "/edge-infra.orchestrator.apis/v1",
...
func Config() (*GlobalConfig, error) {
	...
	inventoryAddress := flag.String(client.InventoryAddress, defaultCfg.Inventory.Address, client.InventoryAddressDescription)
